function Invoke-ADCGetAuditStats {
    <#
    .SYNOPSIS
        Get Audit statistics object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-ADCGetAuditStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-ADCGetAuditStats -GetAll 
        Get all audit data.
    .EXAMPLE
        PS C:\>Invoke-ADCGetAuditStats -name <string>
        Get audit object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-ADCGetAuditStats -Filter @{ 'name'='<value>' }
    ...
    begin {
        Write-Verbose "Invoke-ADCGetAuditStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type audit -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type audit -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving audit configuration for property ''"

            } else {
                Write-Verbose "Retrieving audit configuration objects"
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type audit -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-ADCGetAuditStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA9lStODrMoxAl1
# PCsePnGW2kiLUf3pF28ETZ5zEMK+R6CCHnAwggTzMIID26ADAgECAhAsJ03zZBC0
...
# DAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgl5Rfmnw/iqJUoTqTuRSw4yrv
# pftT2eA69g/444QP8OQwDQYJKoZIhvcNAQEBBQAEggEAbAPyRnzT4RnYhgAa7U2t
# ieq4PuNvFZ3PGu82V3FxeqzRsWOnWF3MJnCxk+6EMsxCm1O7qy4efStUdpBr3ula
# pDCOJTj00FKuyTB28hmfZCpji7e7Fq1FXdenJzkaZcF9yTwZl+DoOOlO+UywMbQ/
# pKLrE3VFlCDlXmJeAKhiM5ZPRF/jWl+HUrnVROG1Sdg44uRePEFCestYoGG6OQ/I
# VuGeVdyTZQfYfvq2i3kcy7mYeSgL77VprBBOBtepYGjkk2sptwjOQ6wQRj/dAP+D
# L9qaVo6PzxN+h3GMxiEnac2MbRhQu2omtTisNX4ItuFMiPtFmdK5gBaLHU0lGfTI
# jqGCA0wwggNIBgkqhkiG9w0BCQYxggM5MIIDNQIBATCBkjB9MQswCQYDVQQGEwJH
# QjEbMBkGA1UECBMSR3JlYXRlciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3Jk
# MRgwFgYDVQQKEw9TZWN0aWdvIExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNB
# IFRpbWUgU3RhbXBpbmcgQ0ECEQCMd6AAj/TRsMY9nzpIg41rMA0GCWCGSAFlAwQC
# AgUAoHkwGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcN
# MjIwNDAzMTkwODA5WjA/BgkqhkiG9w0BCQQxMgQwRHoL1dP9nfS77rxu42io984B
# lXwfxY6MXsrP64A2klc/NtTeri2pnORtDnv1o85zMA0GCSqGSIb3DQEBAQUABIIC
# AHpQcMqfIpbNI7KYkZrlsIOUQWCLz4OBUHPF/jrK6CX0Wr3KXum3mDMxvF1fjLJU
# qtuHXNDMuVKqpsXfyPWygO2vT4MQozAR7rjtu8Qhbms0bHKdSvc6LupjFa3BZcU+
# ME+sVpWAbdS0oathRxp54XLn/8PSa9QENHHNTDDx3uZgMU7Q92/VTBcUOtBUJ6/0
# 2OvOlwidFU9KfDkWFDmiI0jb++30ZJm1eZzbA0qgrCn+AK5aCAcng31QHSxIBa8T
# Guzf3Gl4QmBpccmnLXRuJMVUm/XUZMTRC+iCBqgjk6+pQgdiHt1bPr0hfFitFX0X
# PbnnQBE9s6a1I0EpOlHcxB5hyhTjpD4XhnyghCzEucUaMMb7hIHkVfEzaELhZjwy
# eQbB3GUPjfhBRX1pAsjH6cYQSK4i2oQSlluK/Nq6soFqC2d0d6Ztav6kLr7Talw9
# L0WnfBWDMhZWdqUYhs+WJeiHoJK+GSnmCaxASYZkx+s6Gut4TTVRXJiNWKotascN
# tCQ0S8vLQ+sNmDTNhEvmaOlZ870Jwn7Ccy+crWPeT54JSIE78SW58bkonoN+4/p2
# pvfenyRoW8gLN+ncOmpGv5JgJ1UXxTj/XhQmrRVGiqgccmbxe/bN6jvCTS2O5qcW
# 6W3ThQkbe0DOZLmWVrxK4a5Hkmi1b9/PiPSODmP+M06T
