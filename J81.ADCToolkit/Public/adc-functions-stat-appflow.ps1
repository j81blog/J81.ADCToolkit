function Invoke-ADCGetAppflowStats {
    ...
    .EXAMPLE
        PS C:\>Invoke-ADCGetAppflowStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-ADCGetAppflowStats -GetAll 
        Get all appflow data.
    .EXAMPLE
        PS C:\>Invoke-ADCGetAppflowStats -name <string>
        Get appflow object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-ADCGetAppflowStats -Filter @{ 'name'='<value>' }
    ...
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type appflow -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type appflow -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
                ...
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type appflow -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCUQAcn2RJFye/p
# C4NuoyRUyCcbQaIlC5S8MqTTWrHAg6CCHnAwggTzMIID26ADAgECAhAsJ03zZBC0
...
# DAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg1QIN22UFVlbZiJd4H21gsZqn
# qHDETPr9O+zc+DkE8bAwDQYJKoZIhvcNAQEBBQAEggEAitBSBkmHD5Dv4lgQNZhu
# yy0WhmXPAs4WYcElavsmzBghBFYSVu6EHHLloSzuHClbAWmO2ILNlNNrAgSVB0h8
# arxCBv4nI8b+DSWcnRJc9TDE6SRNCH2axWIacyTxn4RSDE4G0n550R0bHZnwfPoM
# YoxHmtntyYXAyiuSaCNtCXFMfmknK/5mVFXcIYe4QPCmP5FDLP0eI1N4zoK3vsp7
# be+gLcIDHD2np7gZUkgg7noBdaqZLHIySDe8mnqDzKTv52qemJlRhpMGZFp2lTEp
# 4K2dU1t5BAXrI8OWyQsl5mbJ1V3jxOYbaEP7l4Pe2590ggrEGk+e4pyA9agVcLOi
# W6GCA0wwggNIBgkqhkiG9w0BCQYxggM5MIIDNQIBATCBkjB9MQswCQYDVQQGEwJH
# QjEbMBkGA1UECBMSR3JlYXRlciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3Jk
# MRgwFgYDVQQKEw9TZWN0aWdvIExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNB
# IFRpbWUgU3RhbXBpbmcgQ0ECEQCMd6AAj/TRsMY9nzpIg41rMA0GCWCGSAFlAwQC
# AgUAoHkwGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcN
# MjIwNDAzMTkwODAwWjA/BgkqhkiG9w0BCQQxMgQwDiKyQptlXQBbqi3Ccy8a+j50
# rhQNPlEXo8vUmSzpkGO9VJIULz10xHJl0zWf2v4AMA0GCSqGSIb3DQEBAQUABIIC
# AGdwuqAtKJn9Kcbn4DihGaaFv1B9FPD0BScsBd60asp+SlHfTgFluHN94fMqk8jm
# wHJ6kC3zvq2phOf9ZKwm98gs2FHfXAWeuZo2ZKt13TZTKKg9HGHQuRv+rLlEsZI6
# pCj2dYybQDwoajk+S6Ngr5068RkR3ho9rBFHV/YwS/6bmVB3/bmVERqunhFU5gmV
# bNcGCdCOaD92wIvJlGlmQOsmg3xjn8Q/p5vSJ5saFrtbZxbZiiLbxohz9MH0TN2H
# YGq+cB5HpagVPAuc58woM72XQHnrAZwXVUbFQYZEWzry/okSorDbFDs5H1Zhr5GZ
# oG1ujftOH7zShAcg6YPvziz6Vt95F2QRGs9lb+v0CqToXv/StweEv75vBtHFmKPe
# vZXDNS5Umjn9uuoRU1sZOQppZYco2YLKvAQHj5jifDiqvbQRnmWUCSz3M5H2WG2X
# crNlHgwQOSMY8hzFHYInAgtRDrWMyWvmrf1LCxpkEasVJwBsFiBA9A/h9tQHJGsX
# qgdiUPBgnAUC8W3aoDCUjKeo2JfgdLrF82p/gUgKbV3XKtAxMZr5KFex9bATKw2A
# yoJlvW1VvChyMc9uK7pBPl0OkOKQkJZorh4a2T3E3Bj/BvGwYThTd+EwzlouTIS/
# +UEB0yBzwnu5ZZnCmDP0HYalZBir7VdN1Qk2HxnyiXJi
