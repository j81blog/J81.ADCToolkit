function Invoke-ADCGetHanodeStats {
    <#
    .SYNOPSIS
        Get High Availability statistics object(s).
    .DESCRIPTION
    ...
    .EXAMPLE
        PS C:\>Invoke-ADCGetHanodeStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-ADCGetHanodeStats -GetAll 
        Get all hanode data.
    .EXAMPLE
        PS C:\>Invoke-ADCGetHanodeStats -name <string>
        Get hanode object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-ADCGetHanodeStats -Filter @{ 'name'='<value>' }
    ...
    begin {
        Write-Verbose "Invoke-ADCGetHanodeStats: Beginning"
    }
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type hanode -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type hanode -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving hanode configuration for property ''"

            } else {
                Write-Verbose "Retrieving hanode configuration objects"
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type hanode -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
        ...
        Write-Verbose "Invoke-ADCGetHanodeStats: Ended"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBuPL4SNbZ388ue
# iPQCiWmgxXou+4d+SzYzgLA/dQuu46CCHnAwggTzMIID26ADAgECAhAsJ03zZBC0
...
# DAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg65akXjHSeUWJf80YwE5CTRZ6
# lQDPaEsLpbACLMo1sRgwDQYJKoZIhvcNAQEBBQAEggEAG5qs9UDHeypLo5CXP4hw
# a+5pqi7jdgkAuEJydu9XeSm4gYEv4R+GYiBve/mntl/zXFjO5dVlbW8+jkIziNHP
# QddpKLe0rlDoVKhaAwvsqBl+vixe230/lcPzkOAEOqgwzLvKL20Y2m5I4NrWa67I
# Y6fcobrU1dgfQUcFmvGeKrrq2PTp9gBskFa74g0rviCYowZcj9RIiB1XnI0S8T6I
# EyegRSNH7jSPqA5O5JVVsuovSQYgT8QsGlvVncQdu61NmhPC0wRA0jp2K/RAT00V
# OYh3st1Tfwl/yFAuTlCE+cIrdZ5fc19zZCBsLYbBPujVQ6jKW/tCy858RwiwxDsx
# hqGCA0wwggNIBgkqhkiG9w0BCQYxggM5MIIDNQIBATCBkjB9MQswCQYDVQQGEwJH
# QjEbMBkGA1UECBMSR3JlYXRlciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3Jk
# MRgwFgYDVQQKEw9TZWN0aWdvIExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNB
# IFRpbWUgU3RhbXBpbmcgQ0ECEQCMd6AAj/TRsMY9nzpIg41rMA0GCWCGSAFlAwQC
# AgUAoHkwGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcN
# MjIwNDAzMTkwODU3WjA/BgkqhkiG9w0BCQQxMgQwW28Ni+aEddSCfhylpDAQiV7Z
# XNaWWxrsxsMec+tJeLSMZUXOBlVP4Fr7eDBfAmTuMA0GCSqGSIb3DQEBAQUABIIC
# AA8jRmPunYW/0jTsKKPnI8KJWrH9M9QH5XMIWdTkIcQXJFyvriWtsQykoFw9RNdz
# 9oDc3v/RNvaTRDXYq9crOfIbp1Snlxzf6p1sVwRxsc6feVaDCeCez3wF+tur4W2p
# 6qUoooMCt5RoKqBwhGpZ648Zoiv+AhqivJk73rgYT6/jva3+DxA5aCGMydR/Jd0h
# G1LPC+cxgZwhwM22XC09Mq1hnEIoN081iHjelhYuzA1E9NZIpKDRuVsoSdlnUyqi
# Wp2ESWgSTBLfBWbvyYHFJqQyyD/Lymw21utE7GNxvhJxBUBZj42OgfsfpbjKNUED
# ey6YTJMOfcuwMHRLKGqr8AftncemmeVNB2iAyZ4JO75YErMbEWWCe43B8b4ABHgW
# asR/UN0NPtVg4moMJFr1mFOeu0/d50tl3t3P2xrHfOY/AigJLeawa66L5yXfdXt/
# U1LJnuiXLaqdkKdabu9CpCcY94eSnw1i9VgzT2XtKmBdmD6ZAXgR+GzNu/H57bRH
# Xasy8PJRCpUoR/Yox/WgD/c+gFCmh4WvG5VpmzH9EEJ4lbotH61H3Y1bQdsI81Or
# PEFyWZcezo/heIOXiUSbendQ1GRlAZubisYP9piVv3HojGPEMccVVLPla95uW88u
# oXi3JZapom/dbBH5WtxGxC05Y648LV6R0D9xfByOaC3R
