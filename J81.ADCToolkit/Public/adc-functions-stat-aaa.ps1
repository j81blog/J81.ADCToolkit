function Invoke-ADCGetAaaStats {
    ...
    .EXAMPLE
        PS C:\>Invoke-ADCGetAaaStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-ADCGetAaaStats -GetAll 
        Get all aaa data.
    .EXAMPLE
        PS C:\>Invoke-ADCGetAaaStats -name <string>
        Get aaa object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-ADCGetAaaStats -Filter @{ 'name'='<value>' }
    ...
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type aaa -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type aaa -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving aaa configuration for property ''"

            } else {
                Write-Verbose "Retrieving aaa configuration objects"
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type aaa -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDzZ0HVnzHK9hDv
# jIBO/8TSx2chBev53xnn0LxqOTuIvaCCHnAwggTzMIID26ADAgECAhAsJ03zZBC0
...
# DAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgGWDif2qf8ytglI1YpKTXwTBF
# IX2+HUuGH3QnVkiZZJ0wDQYJKoZIhvcNAQEBBQAEggEAQBa0UdHibC/WUPEdUk9r
# VgBzBMTGj6R/To1iyAy/HW7Wv3fVz8Erwgi2dEdQ7gQYKN/iT7y45+N1B5DjLwKk
# IQl2WPJrIrzthO05tzcEKjr8QRi4sA7n8OLP/XzQATtzNStQtyJHFiQ90VzoTW5p
# epdQrSgxjGtaxk6tJEgW5GNv42ZFS4y65X5lC0UXllY7/KlUVd4VZFyK0qtI3YfY
# nFHV07aSVcZCbYlaQMe7LZY1A3mknJ9UYzxYZkFXFkDTCZNGpIxKViGyEnNqoFZx
# u7ewmrJVlxDsPnui06UFFReVmE+4wkaveICMPSxj98+CkNpnXvzXdmAQ7kDek7Fo
# RKGCA0wwggNIBgkqhkiG9w0BCQYxggM5MIIDNQIBATCBkjB9MQswCQYDVQQGEwJH
# QjEbMBkGA1UECBMSR3JlYXRlciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3Jk
# MRgwFgYDVQQKEw9TZWN0aWdvIExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNB
# IFRpbWUgU3RhbXBpbmcgQ0ECEQCMd6AAj/TRsMY9nzpIg41rMA0GCWCGSAFlAwQC
# AgUAoHkwGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcN
# MjIwNDAzMTkwNzU2WjA/BgkqhkiG9w0BCQQxMgQw9ijlM4fIF0qsSPJrwND9u0Ng
# lIZLTU1r9SpFwMNJ/O6vkRA7uOqZpKAO8hUprJrOMA0GCSqGSIb3DQEBAQUABIIC
# AF/ZnblA4dFLdgFcmRR6/OR5/Wat3JlfgL/cydE3K+fE5b+Cad2CXyFRurBde3d+
# DrSvdMM0NrmtV//7baUKesn7yPbc8nyGK9GGvSKOLJPpHkD3ne0bJaW7PBCnCm4Y
# 6b/PCIN42nrcpfUS+57ssehCXl4HVJPwSKuZZp9wdQ8+IWzNT9qcB/3oAmwEeMWP
# /aSg8ud3CtoWT2NK341Bg9W6V4RHxaQGT1U2gaTw5ZPfaV5Tpbg/oWcTt+G0jAdI
# 1yEDCsZck7rZtMjL8BX1Sw1/cW6wRSNX2PHA5HJaaEhdTuR55Cu35B8h9Xt1BNIa
# zaSt1w9C6T1I3zXhnWQZEFP9L9E0ciw5xRYwliFgH8n73TpYMWDR3y5cZgh6NuQ7
# DzIgbsnt+mcgwg/3f5dY6rht/FGR60RZmSt0L08/xp378s/PlR4etiKuhUvedfyU
# 2gYL7VdIntTjZsPp3SHpoHOidLg4TUNd5jyczaiZJ35ciJ1UT66WGVrFZq9WESCl
# IPLBN127TnNafh/hWNfGlE8reJIWw80TKIkdM7DErYUV3ca4k2iyKjDzymFouVe8
# yaIuESaA6fel1CbOsiJ/KNvXfAj0U5o1tdQyxPShZz1RfJm3/npuBL8bPScknUox
# t9o8I36qYQn+6jR5yKSrGj2WIL2WoVDtrb9C3XPGOkCD
