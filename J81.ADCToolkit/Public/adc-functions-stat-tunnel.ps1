function Invoke-ADCGetTunneltrafficpolicyStats {
    ...
    .EXAMPLE
        PS C:\>Invoke-ADCGetTunneltrafficpolicyStats
        Get data.
    .EXAMPLE 
        PS C:\>Invoke-ADCGetTunneltrafficpolicyStats -GetAll 
        Get all tunneltrafficpolicy data.
    .EXAMPLE
        PS C:\>Invoke-ADCGetTunneltrafficpolicyStats -name <string>
        Get tunneltrafficpolicy object by specifying for example the name.
    .EXAMPLE
        PS C:\>Invoke-ADCGetTunneltrafficpolicyStats -Filter @{ 'name'='<value>' }
    ...
    process {
        try {
            if ( $PsCmdlet.ParameterSetName -eq 'GetAll' ) {
                ...
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type tunneltrafficpolicy -NitroPath nitro/v1/stat -Query $query -Summary:$ViewSummary -Filter $Filter -GetWarning
                ...
                $arguments = @{ } 
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type tunneltrafficpolicy -NitroPath nitro/v1/stat -Arguments $arguments -GetWarning
            } elseif ( $PsCmdlet.ParameterSetName -eq 'GetByResource' ) {
                Write-Verbose "Retrieving tunneltrafficpolicy configuration for property 'name'"
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type tunneltrafficpolicy -NitroPath nitro/v1/stat -Resource $name -Summary:$ViewSummary -Filter $Filter -GetWarning
            } else {
                Write-Verbose "Retrieving tunneltrafficpolicy configuration objects"
                $response = Invoke-ADCNitroApi -ADCSession $ADCSession -Method GET -Type tunneltrafficpolicy -NitroPath nitro/v1/stat -Summary:$ViewSummary -Query $query -Filter $Filter -GetWarning
            }
        } catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDlC//zZbIyH1hL
# +Jk7v3eHjzOCbyUaX5AwwMy2QkIPwaCCHnAwggTzMIID26ADAgECAhAsJ03zZBC0
...
# DAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg31+1QlAWbaqhQWsuqi8bB42K
# L3ckPEQkVZcrSqwvEJowDQYJKoZIhvcNAQEBBQAEggEAFAXo7RZVpSSZpG/d7OMu
# JKT1EeQoIXNQUqgnrdQGD7Mjwcs9s6+bEfm2HJfVpaAnkf8Tusfztt8ndFM/m9Ml
# ZEaGkY+shGU2LQBwa3zgoecZcpqA0SrfY0PxHjgOyB71845MM33a+4s1U8HVMtNE
# RAFzxdF5Yx1SrrqHdNlh7Ey2BCboWAcSrn5M9s59dveAteAji8NpH8Hi7qZX5N5o
# XU1F0cN70eK+kZE2UmBw0d0VWHGWkFQmP9l7/z0NV3JKqlUtnVP4xyarrr3p1+ag
# k5ANPuSkj1biQQibhP00EMmSRwPUoUUd+t5UvBVxALyuCk+0VhQQUYqintYSDjuN
# E6GCA0wwggNIBgkqhkiG9w0BCQYxggM5MIIDNQIBATCBkjB9MQswCQYDVQQGEwJH
# QjEbMBkGA1UECBMSR3JlYXRlciBNYW5jaGVzdGVyMRAwDgYDVQQHEwdTYWxmb3Jk
# MRgwFgYDVQQKEw9TZWN0aWdvIExpbWl0ZWQxJTAjBgNVBAMTHFNlY3RpZ28gUlNB
# IFRpbWUgU3RhbXBpbmcgQ0ECEQCMd6AAj/TRsMY9nzpIg41rMA0GCWCGSAFlAwQC
# AgUAoHkwGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcN
# MjIwMzMwMTkzNDUwWjA/BgkqhkiG9w0BCQQxMgQwgxaPpfFzRtJuru8OPybKBnK6
# 8oOLaWdSG7aX7oEP5pSGENOmK+x+YmCzy/uwJnd1MA0GCSqGSIb3DQEBAQUABIIC
# ADEp3i6Hn98wD7RawOMNblwVrKJmX1KAp434/qnGu4bCoH72Udm/m+fogbr04yNS
# +96vZMnnZBLPfQTR/3OpdoLUHoP/QBm4tApv+xi9yNPIg9+1oyKxh+3gOsWVcScQ
# eUUPm/a/QQ1vTPxm78Ayj8utgk7aO6uULnUGYltZuGLQ5Yt3pYstJh6EOhVL5RnX
# dFeoo+bybgn5y+KYdVZT3Udg7T0fnQsZR4cSGrXAiuSI1hVHQHl0w9OCwZeYAZuf
# wtLR4GiVE7SCvW5FWB8ZZDj7VrNfOrRXHXWlGzZGr3W8Fj5GLH6hqfhnEIQmRLw8
# dqOK2cx1LvPFkI8lcjEOyShZ7dPcyu4Cdt1IyF8se5NeSzu7qKnXTRDqnlpgNELt
# 4iQ0mpH4V97JpPUZWTFH46XcWfpzlC0f9TyF7APNfgYivQSbBHL9hpbWEQUgOBYz
# FkIjchJxhbFTFopT9qjFYfgd3iAWROea/k9xDgee1tumBzV5GFT6JXmTNqLJ95jV
# 8fMBgxR39x9XVL4te2CwrjgBSSHb+fKXZ5yc4rHwKHt5e2fux0lxIlCR8APn6GgW
# lp3hNxaxIs34N+1fO+Bp1filXqhx90eIAZZaw2pSeUjEs/4A8yW5Auy+h+Hvdcn+
# a5eJZzjok53Vg/BoKlTrGYImSYW5eeICu//la4XewQSy
